                    ...
                    <tbody>
                        @foreach ($data as $d)
                            <tr>
                                ...
                                <td>{{ number_format($nettoYear, 2, ".", ",") }}</td>
                                <td>{{ number_format($d->ptkp->ptkp_2016, 2, ".", ",") }}</td>
                                <td>
                                    @php
                                        if ($cekPkp > 0) {
                                            $pkpSetahun = $cekPkp;
                                ...
                                <td>
                                    ...
                                    @endphp
                                    {{ number_format($pkpSetahun * ($tax/100), 2, ".", ",") }}
                                </td>
                                <td>{{ number_format(($pkpSetahun * ($tax/100)) / 12, 2, ".", ",") }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
